...
(function(e) {
    ...
    e(document).mouseup(function() {
        ...
        function() {
            ...
            _create: function() {
                var t = this.options;
                this.prevShow = this.prevHide = e(), this.element.addClass("ui-faq ui-widget ui-helper-reset").attr("role", "tablist"), t.collapsible || t.active !== !1 && null != t.active || (t.active = 0), this._processPanels(), 0 > t.active && (t.active += this.headers.length), this._refresh()
            },
            ...
            _createIcons: function() {
                ...
                t && (e("<span>").addClass("ui-faq-header-icon ui-icon " + t.header).prependTo(this.headers), this.active.children(".ui-faq-header-icon").removeClass(t.header).addClass(t.activeHeader), this.headers.addClass("ui-faq-icons"))
            },
            _destroyIcons: function() {
                this.headers.removeClass("ui-faq-icons").children(".ui-faq-header-icon").remove()
            },
            _destroy: function() {
                var e;
                this.element.removeClass("ui-faq ui-widget ui-helper-reset").removeAttr("role"), this.headers.removeClass("ui-faq-header ui-faq-header-active ui-state-default ui-corner-all ui-state-active ui-state-disabled ui-corner-top").removeAttr("role").removeAttr("aria-expanded").removeAttr("aria-selected").removeAttr("aria-controls").removeAttr("tabIndex").removeUniqueId(), this._destroyIcons(), e = this.headers.next().removeClass("ui-helper-reset ui-widget-content ui-corner-bottom ui-faq-content ui-faq-content-active ui-state-disabled").css("display", "").removeAttr("role").removeAttr("aria-hidden").removeAttr("aria-labelledby").removeUniqueId(), "content" !== this.options.heightStyle && e.css("height", "")
            },
            _setOption: function(e, t) {
            ...
            _processPanels: function() {
                var e = this.headers,
                    t = this.panels;
                this.headers = this.element.find(this.options.header).addClass("ui-faq-header ui-state-default ui-corner-all"), this.panels = this.headers.next().addClass("ui-faq-content ui-helper-reset ui-widget-content ui-corner-bottom").filter(":not(.ui-faq-content-active)").hide(), t && (this._off(e.not(this.headers)), this._off(t.not(this.panels)))
            },
            _refresh: function() {
                var t, i = this.options,
                    s = i.heightStyle,
                    n = this.element.parent();
                this.active = this._findActive(i.active).addClass("ui-faq-header-active ui-state-active ui-corner-top").removeClass("ui-corner-all"), this.active.next().addClass("ui-faq-content-active").show(), this.headers.attr("role", "tab").each(function() {
                    var t = e(this),
            ...
            _eventHandler: function(t) {
                ...
                t.preventDefault(), a && !i.collapsible || this._trigger("beforeActivate", t, l) === !1 || (i.active = o ? !1 : this.headers.index(n), this.active = a ? e() : n, this._toggle(l), s.removeClass("ui-faq-header-active ui-state-active"), i.icons && s.children(".ui-faq-header-icon").removeClass(i.icons.activeHeader).addClass(i.icons.header), a || (n.removeClass("ui-corner-all").addClass("ui-faq-header-active ui-state-active ui-corner-top"), i.icons && n.children(".ui-faq-header-icon").removeClass(i.icons.header).addClass(i.icons.activeHeader), n.next().addClass("ui-faq-content-active")))
            },
            _toggle: function(t) {
                var i = t.newPanel,
            ...
            _toggleComplete: function(e) {
                var t = e.oldPanel;
                t.removeClass("ui-faq-content-active").prev().removeClass("ui-corner-top").addClass("ui-corner-all"), t.length && (t.parent()[0].className = t.parent()[0].className), this._trigger("activate", null, e)
            }
        }), e.widget("ui.menu", {
            version: "1.11.2",
            defaultElement: "<ul>",
